...
def read_out_file():
    ...
    try:
        raw_input("Уважаемый пользователь.ниже написана небольшая инструкция"+'\n'
                  ...
                  "6.Если вы все выполнили и поняли-нажмите 'Enter' и добро пожаловать в лабиринт =]"                                                                                                                                                                                                                                                                                                                                                                                                                                                     "6.Если вы все выполнили и поняли-нажмите 'Enter' и добро пожаловать в лабиринт =]")
